...
### 3. Agent System Design (Weeks 4-6)
...
### 4. Technical Implementation (Weeks 7-11)
...
### 5. Testing and Evaluation (Weeks 12-13)
...
### 6. Final Documentation and Presentation (Weeks 14-15)
...
- Access credentials to GBI SQL server with sample data
- GBI business process documentation and organizational charts
...
### Database and Integration Resources
- GBI SQL Server schema documentation
- Sample database entity relationship diagrams
- GBI business process flowcharts
- [Microsoft SQL Server Documentation](https://learn.microsoft.com/en-us/sql/sql-server/)
- Various CRM/ERP system documentation (depending on your proposed solution)
